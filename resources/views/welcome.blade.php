@include('partials.Header')
                        ...
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                ...
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                    ...
                                    <a id="btn-projects" class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" href="{{ route('projects')}}">Projects</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img  zoomeble-image" src="{{ asset($user->profile_photo_path) }}" style="border-radius:30px;"/>
                                    <div class="dots-1">
            ...
            <!-- About Section-->
            <section id="sec-welcome" class="bg-light py-5">
